...
export default function Footer() {
  ...
  const footerLinks = {
    product: [
      ...
      { label: "Mock Interviews", href: "/interviews/setup" },
      { label: "Dashboard", href: "/dashboard" },
      { label: "Interview History", href: "/interviews/history" },
    ],
    company: [
      { label: "About Us", href: "#" },
      { label: "Careers", href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-foreground/60 text-sm leading-relaxed">
              AI-powered career preparation platform for job seekers. Master your interviews with confidence.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-foreground/60 text-sm">
            © {currentYear} MindMock. All rights reserved.
          </p>
